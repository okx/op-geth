...
// Package-level variable to hold the mock server instance
var mockErigonServer *httptest.Server

// TestMain runs before all tests in the package
// This is the entry point for the test suite and allows for global setup/teardown
func TestMain(m *testing.M) {
	...
	// Teardown: Close the mock server after all tests complete
	log.Info("Shutting down mock Erigon server...")
	mockErigonServer.Close()
