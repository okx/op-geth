...
var (
	...
	gaslessAddrChain196  = common.HexToAddress("0x420000000000000000000000000000000000002F")
	gaslessAddrChain1952 = common.HexToAddress("0xA53fEda2b0d946436f34B591A25c256d8a9ae4E0")
)
...
// Pre-computed selector for the auto-generated getter of
//
//	bool public gaslessEnabled;
var gaslessEnabledSelector = crypto.Keccak256([]byte("gaslessEnabled()"))[:4]

// GaslessEnabledCalldata returns the calldata for invoking the gaslessEnabled()
// auto-generated getter.
func GaslessEnabledCalldata() []byte {
	out := make([]byte, 4)
	copy(out, gaslessEnabledSelector)
	return out
}

// DecodeGaslessEnabled parses the ABI-encoded `bool` return of gaslessEnabled().
// Layout: 32 bytes; non-zero last byte means true.
func DecodeGaslessEnabled(ret []byte) (bool, error) {
	if len(ret) < 32 {
		return false, errors.New("gasless: gaslessEnabled return too short")
	}
